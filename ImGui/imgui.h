...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsPinkMagenta(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsPinkMagentaSoft(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsPinkMagentaNeon(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsPinkMagentaDark(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsPinkMagentaBright(ImGuiStyle* dst = NULL);
